...
parser.add_argument('--use_temporal', type=int, default=1, help='1: use temporal sequences, 0: only KG')
parser.add_argument('--seq_weight', type=float, default=0.5, help='weight of sequential loss')
...
parser.add_argument(
    ...
    default='[\'dataset\',\'aggregator\',\'n_epochs\',\'neighbor_sample_size\','
            ...
            '\'use_temporal\',\'max_seq_length\',\'num_heads\',\'seq_weight\']',
    help='paramerts')
...
# data = load_data(args)
# To:
n_user, n_item, n_entity, n_relation, train_data, eval_data, test_data, adj_entity, adj_relation, user_item_adj, user_sequences = load_data(args)

data = (n_user, n_item, n_entity, n_relation, train_data, eval_data, test_data, adj_entity, adj_relation, user_item_adj, user_sequences)
